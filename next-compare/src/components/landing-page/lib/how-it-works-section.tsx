...
export default function HowItWorksSection() {
  return (
    <section className="bg-[#F0D050] p-40">
      <div className="w-full flex h-32  justify-center">
        <h6 className="text-5xl text-[#3F3A3A] font-extrabold">How it works</h6>
      </div>
      <div className="w-full h-3/5">
        <div className="2xl:max-w-[1440px] flex mx-auto justify-center items-center gap-10">
          {howItWorksCards.map((card, index) => (
            <div
              className="h-full bg-white w-[350px] gap-2 rounded-lg flex flex-col items-center border-b-4 border-2 border-black border-b-black p-10"
              key={index}
            >
